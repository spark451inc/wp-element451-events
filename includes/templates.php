<?php
/**
 * SP451_ELEMENT_EVENTS Templates
 */
 ...
 * @package DAS
 */
class SP451_ELEMENT_EVENTS_Template_Loader extends BJN_Template_Loader {
	/**
	 ...
	 * @var string
	 */
	protected $plugin_directory = SP451_ELEMENT_EVENTS_DIR;
