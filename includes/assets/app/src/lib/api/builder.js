...
const BASE_API_URI = `https://${API_OBJECT.client}.${API_OBJECT.apiUrl}/v2/events/list?analytics=${API_OBJECT.analytics}&feature=${API_OBJECT.feature}&&embed[editor]=obj&offset=0&limit=6`;
